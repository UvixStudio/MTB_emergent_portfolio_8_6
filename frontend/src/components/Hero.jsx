...
export default function Hero({ onJump, hideDesktopTagline = false, freezeRoles = false }) {
    const openContact = () =>
    ...
    return (
        <div className="relative h-full w-full">
            ...
            <div className="mx-auto flex h-full max-w-7xl flex-col justify-end px-6 pb-32 sm:justify-center sm:px-8 sm:pb-0">
                {!hideDesktopTagline && (
                    <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                    ...
                    >
                        ...
                        <span className="ml-auto mt-3 block h-0.5 w-16 bg-brand" />
                    </motion.div>
                )}
                ...
                <div className="max-w-4xl">
                    ...
                    <motion.div
                        ...
                        className="mt-3"
                    >
                        <RotatingRoles freeze={freezeRoles} />
                    </motion.div>
